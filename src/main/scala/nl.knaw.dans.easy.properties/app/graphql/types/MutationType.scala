...
trait MutationType {
  ...
  trait Mutation {
    ...
    def registerDeposit(id: DepositId, creationTimestamp: DateTime, depositorId: String): Option[Deposit] = {
    ...
    def updateState(id: DepositId, label: StateLabel, description: String): Option[Deposit] = {
